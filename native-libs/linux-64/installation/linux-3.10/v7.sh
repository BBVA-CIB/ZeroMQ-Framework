...
#: Desc  : This script installs the zeromq native libraries in the linux v7.
...
if [[ -d /var/log ]]; then
        ERRORS_FILE=/var/log/zeromq-installation-errors-linux-7-$DATE.log
else
        ERRORS_FILE=./zeromq-installation-errors-linux-7-$DATE.log
fi
