 ...
 */
public final class LLZSocketSchema
{
    /** Logger of the class */
    private static final Logger LOGGER = LoggerFactory.getLogger(LLZSocketSchema.class);
     ...
     */
    public LLZSocketSchema(final ZMQ.Context context,
